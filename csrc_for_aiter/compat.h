...
#ifndef USE_ROCM
#define MOE_SHFL_XOR_SYNC(var, lane_mask) \
  __shfl_xor_sync(uint32_t(-1), var, lane_mask)
#define MOE_SHFL_XOR_SYNC_WIDTH(var, lane_mask, width) \
...
#ifndef USE_ROCM
#define MOE_SHFL_DOWN_SYNC(var, lane_delta) \
  __shfl_down_sync(uint32_t(-1), var, lane_delta)
#else
#define MOE_SHFL_DOWN_SYNC(var, lane_delta) __shfl_down(var, lane_delta)
#endif
