...
__global__ void __launch_bounds__(256, 1) moe_w8a8_gemm_kernel_block_wise(
...
template <typename scalar_t,
          ...
          bool USE_ATOMIC,
          int THREADS_PER_BLOCK>
void run_moe_w8a8_gemm_block_wise(const uint32_t *input,
                                  ...
                                  int size_k)
{
  ...
  auto kernel = moe_w8a8_gemm_kernel_block_wise<scalar_t, bit, top_k, BLOCK_SIZE_M, BLOCK_SIZE_N, BLOCK_SIZE_K, has_zp, mul_topk_weight, group_size_n, group_size_k, BLOCK_SIZE_M_LOOPS, BLOCK_SIZE_N_LOOPS, BLOCK_SIZE_K_LOOPS, USE_ATOMIC, THREADS_PER_BLOCK>;
  constexpr int K_TILE = 64;
