...
function (hipify_sources_target OUT_SRCS NAME ORIG_SRCS)
  ...
  if(DEFINED HIPIFY_PROJECT_DIR)
    set(HIPIFY_INPUT_DIR ${HIPIFY_PROJECT_DIR})
  else()
    set(HIPIFY_INPUT_DIR ${CMAKE_SOURCE_DIR}/csrc)
  endif()
  add_custom_target(
    hipify${NAME}
    COMMAND ${Python3_EXECUTABLE} ${CMAKE_SOURCE_DIR}/cmake/hipify.py -p ${HIPIFY_INPUT_DIR} -o ${CSRC_BUILD_DIR} ${SRCS}
    DEPENDS ${CMAKE_SOURCE_DIR}/cmake/hipify.py ${SRCS}
    COMMENT "Running hipify on ${NAME} extension source files.")

  # Swap out original extension sources with hipified sources.
  list(APPEND HIP_SRCS ${CXX_SRCS})
  # Pass the target name to the parent scope
